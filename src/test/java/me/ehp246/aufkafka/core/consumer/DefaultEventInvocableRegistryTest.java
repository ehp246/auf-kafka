...
class DefaultEventInvocableRegistryTest {
    ...
    void key_01() {
        ...
        registry.register(EventInvocableNameSource.KEY,
    ...
    void key_02() {
        ...
        registry.register(EventInvocableNameSource.EVENT_HEADER,
    ...
    void error_01() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> registry.register(EventInvocableNameSource.KEY, new EventInvocableDefinition(Set.of(keyValue),
    ...
    void registered_01() {
        ...
        Assertions.assertEquals(true, registry.registered(EventInvocableNameSource.KEY).isEmpty());
    }
}
