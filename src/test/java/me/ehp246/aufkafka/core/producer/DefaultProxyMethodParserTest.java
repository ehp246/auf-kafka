...
class DefaultProxyMethodParserTest {
    ...
    void return_01() throws Throwable {
        ...
        Assertions.assertEquals(null, ((LocalReturnBinder) binder).apply(null,
                new SendRecord(null, new CompletableFuture<RecordMetadata>())));
    }
    ...
    void return_04() throws Throwable {
        ...
        Assertions.assertEquals(sentFuture.get(), binder.apply(null, new SendRecord(null, sentFuture)));
    }
    ...
    void return_05() throws Throwable {
        ...
        final var expected = new SendRecord(null, new CompletableFuture<RecordMetadata>());
    ...
    void return_06() throws Throwable {
        ...
        final var returned = binder.apply(null, new SendRecord(null, sentFuture));
    ...
    void return_07() throws Throwable {
        ...
        final var returned = binder.apply(expected, new SendRecord(null, sentFuture));
    ...
    void return_08() throws Throwable {
        ...
        final var returned = binder.apply(null,
                new SendRecord(expected, new CompletableFuture<RecordMetadata>()));
